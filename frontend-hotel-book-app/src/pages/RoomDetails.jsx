    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            <div className='flex flex-col'>
                <h1 className='text-3xl md:text-4xl font-playfair'>Expirience Luxury Like Never Before</h1>
                <div className='flex felx-wrap items-center mt-3 mb-6 gap-4'>
            ...
            <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                ...
                <div className='flex flex-col'>
                    <label htmlFor="checkInDate"
                        className='font-medium'>Check-In</label>
                ...
                <div className='flex flex-col'>
                    <label htmlFor="guests"
                        className='font-medium'>Guests</label>
        ...
        <div className='flex flex-col items-start gap-4'>
            <div className='flex gap-4'>
                ...
                <div>
                    <p className='tex-lg md:text-xl'>Hosted by {room.hotel.name}</p>
