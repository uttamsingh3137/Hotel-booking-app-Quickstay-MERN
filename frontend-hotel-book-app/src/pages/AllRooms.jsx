...
function AllRooms() {
  ...
  //handle changes for filter and sort option
  ...
  //func to check if a room matches the selected room type
  ...
  //func to check if a room matches the selected price range
  const matcheesPriceRange = (room) => {
    return (
  ...
  //filter &  sort rooms based on sort & filter option
