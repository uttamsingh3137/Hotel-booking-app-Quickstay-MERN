...
function Footer() {
  return (
    <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='bg-[#F6F9FC] w-full rounded-2xl p-8 md:p-12 flex flex-wrap justify-between gap-12 md:gap-6'>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <a href="#">QuickStay by Uttam Singh - </a>. All rights reserved.</p>
