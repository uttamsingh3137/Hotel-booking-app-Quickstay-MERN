...
function AddRoom() {
  ...
  return (
    <form>
        <Title align="left" font='outfit' title="Add Room" subTitle="Fill in the details carefully and accurate room details, pricing, and amenitied, to enhance the user booking experience." /> 

        {/* Upload area for Images */}
        <p className='text-gray-800 mt-10'>Images</p>
        <div className='grid grid-cols-3 sm:flex gap-4 my-2 flex-wrap'>
        ...
        <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4 items-end'>
